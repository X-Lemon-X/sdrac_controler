...
db = cantools.database.load_file('src/sdrac_can_stranslator/sdrac_can_stranslator/ariadna_constants/can_messages/output/can.dbc')
...
try:
  Freq = 50
  period = 1/ Freq 
  set_control_mode(arg1, CONTROL_MODE_POSITION)
  while True:
    # get_pos(arg1)
    get_pos(arg1)
